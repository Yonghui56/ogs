...
* properties.
* including the saturation vapor pressure calculation(Kelvin equation regulized
* vapor pressure)
...
public:
    ...
    {
        return _p_0 * exp(((1 / _temperature_0) - (1 / T)) * Water * _h_wg /
                          IdealGasConstant);
    }
    ...
    double calculateDerivativedPsatdT(const double T) const
    {
        return _p_0 * (Water * _h_wg / IdealGasConstant) * (1. / T / T) *
               exp(((1. / _temperature_0) - (1. / T)) * Water * _h_wg /
                   IdealGasConstant);
    }
                                 ...
                                 const double rho_mass_h2o) const
    {
        ...
        return -((p_air_nonwet * Air + p_vapor_nonwet * Water) /
