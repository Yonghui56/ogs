...
#ifndef OGS_TWOPHASEFLOWWITHVANGENUCHTEN_H
#define OGS_TWOPHASEFLOWWITHVANGENUCHTEN_H
...
{
class vanGenuchten : public TwoPhaseFlowWithPPMaterialProperties
{
public:
	...
	double getDerivSaturation(double const pc) const override;
};

}  // end of namespace
}  // end of namespace
#endif /* TWOPHASEFLOWWITHPPVANGENUCHTEN_H */
