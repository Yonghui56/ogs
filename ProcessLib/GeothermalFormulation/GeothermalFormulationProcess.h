 ...
 */
class GeothermalFormulationProcess final : public Process
{
public:
    GeothermalFormulationProcess(
        MeshLib::Mesh& mesh,
...
private:
    ...
    GeothermalFormulationProcessData _process_data;

    std::vector<std::unique_ptr<GeothermalFormulationLocalAssemblerInterface>>
        _local_assemblers;
};
