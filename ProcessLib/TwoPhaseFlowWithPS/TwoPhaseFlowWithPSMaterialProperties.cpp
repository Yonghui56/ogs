...
{
TwoPhaseFlowWithPSMaterialProperties::TwoPhaseFlowWithPSMaterialProperties(
...
int TwoPhaseFlowWithPSMaterialProperties::getMaterialID(
...
double TwoPhaseFlowWithPSMaterialProperties::getLiquidDensity(
...
double TwoPhaseFlowWithPSMaterialProperties::getGasDensity(const double p,
...
double TwoPhaseFlowWithPSMaterialProperties::getGasDensityDerivative(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
double TwoPhaseFlowWithPSMaterialProperties::getLiquidViscosity(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
double TwoPhaseFlowWithPSMaterialProperties::getGasViscosity(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
Eigen::MatrixXd const& TwoPhaseFlowWithPSMaterialProperties::getPermeability(
...
double TwoPhaseFlowWithPSMaterialProperties::getPorosity(
    const int material_id, const double t,
...
double TwoPhaseFlowWithPSMaterialProperties::getNonwetRelativePermeability(
...
double TwoPhaseFlowWithPSMaterialProperties::getWetRelativePermeability(
    const double /*t*/, const ParameterLib::SpatialPosition& /*pos*/,
    const double /*p*/, const double /*T*/, const double saturation) const
{
...
double TwoPhaseFlowWithPSMaterialProperties::getSaturation(
    const int material_id, const double /*t*/,
    const ParameterLib::SpatialPosition& /*pos*/, const double /*p*/,
...
double TwoPhaseFlowWithPSMaterialProperties::getSaturationDerivative(
    const int material_id, const double /*t*/,
    const ParameterLib::SpatialPosition& /*pos*/, const double /*p*/,
