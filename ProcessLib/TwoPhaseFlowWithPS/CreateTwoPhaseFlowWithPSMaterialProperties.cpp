...
{
std::unique_ptr<TwoPhaseFlowWithPSMaterialProperties>
createTwoPhaseFlowWithPSMaterialProperties(
    ...
    std::vector<std::unique_ptr<ParameterLib::ParameterBase>> const& parameters)
{
    ...
    return std::make_unique<TwoPhaseFlowWithPSMaterialProperties>(
