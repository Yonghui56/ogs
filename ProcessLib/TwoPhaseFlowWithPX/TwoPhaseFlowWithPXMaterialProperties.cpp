...
namespace ProcessLib
{
	...
	{
		TwoPhaseFlowWithPXMaterialProperties::TwoPhaseFlowWithPXMaterialProperties(
		...
		void TwoPhaseFlowWithPXMaterialProperties::setMaterialID(
		...
		double TwoPhaseFlowWithPXMaterialProperties::getLiquidDensity(
		...
		double TwoPhaseFlowWithPXMaterialProperties::getGasDensity(const double p,
		...
		double TwoPhaseFlowWithPXMaterialProperties::getDerivGasDensity(
			const double p, const double T) const
		{
			ArrayType vars;
			vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
		...
		double TwoPhaseFlowWithPXMaterialProperties::getLiquidViscosity(
			const double p, const double T) const
		{
			ArrayType vars;
			vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
		...
		double TwoPhaseFlowWithPXMaterialProperties::getGasViscosity(
			const double p, const double T) const
		{
			ArrayType vars;
			vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
		...
		Eigen::MatrixXd const& TwoPhaseFlowWithPXMaterialProperties::getPermeability(
		...
		double TwoPhaseFlowWithPXMaterialProperties::getPorosity(
			const double /*t*/, const ProcessLib::SpatialPosition& /*pos*/,
		...
		double TwoPhaseFlowWithPXMaterialProperties::getNonwetRelativePermeability(
			const double /*t*/, const ProcessLib::SpatialPosition& /*pos*/,
		...
		double TwoPhaseFlowWithPXMaterialProperties::getWetRelativePermeability(
			const double /*t*/, const ProcessLib::SpatialPosition& /*pos*/,
			const double /*p*/, const double /*T*/, const double saturation) const
		{
		...
		double TwoPhaseFlowWithPXMaterialProperties::getCapillaryPressure(
			const double /*t*/, const ProcessLib::SpatialPosition& /*pos*/,
			const double /*p*/, const double /*T*/, const double saturation) const
		{
