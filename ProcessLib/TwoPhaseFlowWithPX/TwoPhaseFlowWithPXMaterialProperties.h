...
#ifndef OGS_TWOPHASEFLOWWITHPXMATERIALPROPERTIES_H
#define OGS_TWOPHASEFLOWWITHPXMATERIALPROPERTIES_H
...
namespace ProcessLib
{
	...
	{
		class TwoPhaseFlowWithPXMaterialProperties
		{
		public:
			using ArrayType = MaterialLib::Fluid::FluidProperty::ArrayType;

			TwoPhaseFlowWithPXMaterialProperties(
