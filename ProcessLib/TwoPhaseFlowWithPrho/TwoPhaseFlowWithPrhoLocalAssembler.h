...
#ifndef OGS_TWOPHASEFLOWWITHPRHOLOCALASSEMBLER_H
#define OGS_TWOPHASEFLOWWITHPRHOLOCALASSEMBLER_H
...
struct IntegrationPointData final
{
	...
	double _sw, _sw_pre;
	double _rho_m, _rho_m_pre;//rho_L^h
	double _dsw_dpg;
	double _dsw_drho;
	double _drhom_dpg;
	double _drhom_drho;
...
public:
              ...
              std::vector<double>(_integration_method.getNumberOfPoints()))
    {
		...
		for (unsigned ip = 0; ip < n_integration_points; ip++)
		{
			...
			_ip_data[ip]._dsw_drho = 0.0;
			_ip_data[ip]._drhom_dpg = 0.0;
			_ip_data[ip]._drhom_drho = 0.0;
		}
    }
...
#endif /* TWOPHASEFLOWWITHPRHOLOCALASSEMBLER_H */
