...
struct IntegrationPointData final
{
    explicit IntegrationPointData(
        ...
        : mat_property(material_property_),
          ...
          porosity_backfill(0.0763),
          porosity_prev_backfill(0.0763),
          rho_mol_co2_cumul_total_backfill(0.0),
          rho_mol_co2_cumul_total_prev_backfill(0.0),
          fluid_volume_backfill(0.0),
          fluid_volume_prev_backfill(0.0),
        porosity_waste(0.0763),
        porosity_prev_waste(0.0763),
        rho_mol_co2_cumul_total_waste(0.0),
        rho_mol_co2_cumul_total_prev_waste(0.0),
        fluid_volume_waste(0.0),
        fluid_volume_prev_waste(0.0)
    ...
    void pushBackState()
    {
        ...
        rho_mol_co2_cumul_total_prev_backfill = rho_mol_co2_cumul_total_backfill;
...
private:
    const double bi_interpolation(double pnt_x_to_interpolate,/*x-coordinate*/
...
private:
    ...
    std::vector<double> _supp_pnts_y = {
        ...
        4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500};  // CUMULATED co2
    std::vector<double> _porosity_at_supp_pnts_backfill = {
        ...
        0.13009791,  0.13009791,  0.13009791,  0.13009791,  0.13009791,
        0.13009791,  0.13009791,  0.1300979,   0.13009791,  0.13009791,
        0.13009791,  0.13009789,  0.13009791,  0.13009789,  0.13009791,
        0.13009791,  0.13009791,  0.13009791,  0.13009791,  0.13009791,
        0.13009791,  0.13009791,  0.13009791,  0.13009788,  0.13009791,
        0.13009791,  0.13009791,  0.13009791,  0.13009791,  0.13009791,
        0.13009791,  0.13009791,  0.13009789};
    ...
    std::vector<double> _pH_at_supp_pnt_backfill = {
        ...
        6.3585847, 6.3585855, 6.3585851, 6.3585847, 6.3585847, 6.3585847,
        6.3585848, 6.3585847, 6.3585847, 6.3585848, 6.3585849, 6.3585847,
        6.3585847, 6.3585847, 6.3585852, 6.3585847, 6.3585853, 6.3585847,
        6.3585847, 6.3585847, 6.3585847, 6.3585847, 6.3585847, 6.3585848,
        6.3585847, 6.3585847, 6.3585858, 6.3585847, 6.3585847, 6.3585847,
        6.3585846, 6.3585848, 6.3585847, 6.3585847, 6.3585847, 6.3585852};
    std::vector<double> _quartz_rate_suppt_pnt_backfill = {
        ...
        -7.07E-19, 2.96E-18,  9.93E-19,  -8.19E-19, -2.18E-18, -2.12E-18,
        -1.20E-18, -1.69E-18, -1.29E-18, -5.62E-19, 2.78E-19,  -1.12E-18,
        -1.18E-18, -1.18E-18, 1.89E-18,  -9.86E-19, 1.77E-18,  -9.22E-19,
        -9.08E-19, -7.53E-19, -2.42E-18, -2.14E-18, -1.49E-18, -1.01E-18,
        -1.59E-18, -1.38E-18, 6.13E-18,  -1.26E-18, -1.19E-18, -1.07E-18,
        -1.23E-18, -5.82E-19, -9.33E-19, -5.97E-19, -8.23E-19, 1.45E-18};
    std::vector<double> _fluid_volume_suppt_pnt_backfill = {
        ...
        349.66437, 349.66437, 349.66437, 349.66438, 349.66438, 349.66438,
        349.66437, 349.66438, 349.66437, 349.66437, 349.66437, 349.66437,
        349.66438, 349.66438, 349.66437, 349.66438, 349.66437, 349.66438,
        349.66438, 349.66438, 349.66438, 349.66438, 349.66437, 349.66437,
        349.66438, 349.66438, 349.66437, 349.66438, 349.66438, 349.66438,
        349.66438, 349.66437, 349.66438, 349.66437, 349.66438, 349.66437};

    // look up table for waste matrix
    const double piecewiselinear_interpolation(double pnt_to_interpolate, std::vector<double>
