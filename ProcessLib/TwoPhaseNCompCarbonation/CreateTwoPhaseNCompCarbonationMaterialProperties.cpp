...
#include "CreateTwoPhaseNCompCarbonationMaterialProperties.h"
        ...
        material_ids)
{
    ...
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__fluid}
    auto const& fluid_config = config.getConfigSubtree("fluid");

    // Get fluid properties
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__liquid_density}
    ...
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__gas_density}
    auto const& rho_gas_conf = fluid_config.getConfigSubtree("gas_density");
    auto _gas_density =
        MaterialLib::Fluid::createFluidDensityModel(rho_gas_conf);
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__liquid_viscosity}
    ...
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__gas_viscosity}
    ...
    //! \ogs_file_param{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium}
    auto const& poro_config = config.getConfigSubtree("porous_medium");
    //! \ogs_file_param{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium__porous_medium}
    for (auto const& conf : poro_config.getConfigSubtreeList("porous_medium"))
    {
        //! \ogs_file_attr{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium__porous_medium__id}
        auto const id = conf.getConfigAttributeOptional<int>("id");
        mat_ids.push_back(*id);

        //! \ogs_file_param{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium__porous_medium__permeability}
        ...
        //! \ogs_file_param{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium__porous_medium__porosity}
        ...
        //! \ogs_file_param{prj__processes__process__TWOPHASE_NCOMP_CARBONATION__material_property__porous_medium__porous_medium__storage}
        ...
        auto const& capillary_pressure_conf =
            //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__capillary_pressure}
        ...
        auto const& krel_config =
            //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__relative_permeability}
            conf.getConfigSubtree("relative_permeability");
        for (
            auto const& krel_conf :
            //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__relative_permeability__relative_permeability}
            krel_config.getConfigSubtreeList("relative_permeability"))
        {
            auto const krel_id =
                //! \ogs_file_attr{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__relative_permeability__relative_permeability__id}
    ...
    return std::unique_ptr<TwoPhaseNCompCarbonationMaterialProperties>{
        new TwoPhaseNCompCarbonationMaterialProperties{
