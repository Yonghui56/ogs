...
{
struct TwoPhaseNCompCarbonationProcessData
{
    TwoPhaseNCompCarbonationProcessData(
        ...
        std::unique_ptr<TwoPhaseNCompCarbonationMaterialProperties>&& material_)
    ...
    TwoPhaseNCompCarbonationProcessData(TwoPhaseNCompCarbonationProcessData&& other)
    ...
    TwoPhaseNCompCarbonationProcessData(TwoPhaseNCompCarbonationProcessData const&) =
        delete;

    //! Assignments are not needed.
    void operator=(TwoPhaseNCompCarbonationProcessData const&) = delete;

    //! Assignments are not needed.
    void operator=(TwoPhaseNCompCarbonationProcessData&&) = delete;
    ...
    std::unique_ptr<TwoPhaseNCompCarbonationMaterialProperties> _material;
    double _dt = 0;
};
