...
{
TwoPhaseNCompCarbonationMaterialProperties::TwoPhaseNCompCarbonationMaterialProperties(
...
int TwoPhaseNCompCarbonationMaterialProperties::getMaterialID(
...
double TwoPhaseNCompCarbonationMaterialProperties::getLiquidDensity(
...
double TwoPhaseNCompCarbonationMaterialProperties::getGasDensity(const double p,
...
double TwoPhaseNCompCarbonationMaterialProperties::getGasDensityDerivative(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
double TwoPhaseNCompCarbonationMaterialProperties::getLiquidViscosity(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
double TwoPhaseNCompCarbonationMaterialProperties::getGasViscosity(
    const double p, const double T) const
{
    ArrayType vars;
    vars[static_cast<int>(MaterialLib::Fluid::PropertyVariableType::T)] = T;
...
Eigen::MatrixXd const& TwoPhaseNCompCarbonationMaterialProperties::getPermeability(
...
double TwoPhaseNCompCarbonationMaterialProperties::getPorosity(
    const int material_id, const double /*t*/,
...
double TwoPhaseNCompCarbonationMaterialProperties::getNonwetRelativePermeability(
...
double TwoPhaseNCompCarbonationMaterialProperties::getWetRelativePermeability(
    const double /*t*/, const ProcessLib::SpatialPosition& /*pos*/,
    const double /*p*/, const double /*T*/, const double saturation) const
{
...
double TwoPhaseNCompCarbonationMaterialProperties::getSaturation(
    const int material_id, const double /*t*/,
    const ProcessLib::SpatialPosition& /*pos*/, const double /*p*/,
...
double TwoPhaseNCompCarbonationMaterialProperties::getSaturationDerivative(
    const int material_id, const double /*t*/,
    const ProcessLib::SpatialPosition& /*pos*/, const double /*p*/,
