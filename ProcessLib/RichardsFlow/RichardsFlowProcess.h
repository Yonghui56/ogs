...
namespace ProcessLib
{
    ...
    namespace RichardsFlow
    {
        ...
        private:
            ...
            {
                DBUG("AssembleJacobian RichardsFlowProcess.");
                ...
                GlobalSetup::executeMemberDereferenced(*_global_assembler,
					&GlobalAssembler::assembleJacobian,
            ...
            {
				//Eigen::Map<Eigen::VectorXd> local_x0(x.data(), x.size());
				//_process_data.local_x0
                DBUG("PostTimestep RichardsFlowProcess.");
				
                GlobalSetup::executeMemberDereferenced(*_global_assembler,
					&GlobalAssembler::postTimestep,
