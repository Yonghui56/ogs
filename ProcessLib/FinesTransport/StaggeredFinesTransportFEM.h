...
template <typename ShapeFunction, typename IntegrationMethod,
          unsigned GlobalDim>
class StaggeredFinesTransportFEM : public FinesTransportFEM<ShapeFunction, IntegrationMethod, GlobalDim>
{
...
public:
    StaggeredFinesTransportFEM(MeshLib::Element const& element,
...
#include "StaggeredFinesTransportFEM-impl.h"
