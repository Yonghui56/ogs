...
struct FinesTransportMaterialProperties;

/**
 * # FinesTransport process
 *
 ...
 * */
class FinesTransportProcess final : public Process
{
public:
...
private:
    ...
    std::vector<std::unique_ptr<FinesTransportLocalAssemblerInterface>> _local_assemblers;
