        ...
        material_ids)
{
    ...
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium}
    auto const& poro_config = config.getConfigSubtree("porous_medium");
    //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium}
    for (auto const& conf : poro_config.getConfigSubtreeList("porous_medium"))
    {
        //! \ogs_file_attr{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__id}
        auto const id = conf.getConfigAttributeOptional<int>("id");
        mat_ids.push_back(*id);

        //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__permeability}
        ...
        //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__porosity}
        ...
        //! \ogs_file_param{prj__processes__process__TWOPHASE_CARBONATION__material_property__porous_medium__porous_medium__storage}
    ...
    return std::unique_ptr<TwoPhaseCarbonationMaterialProperties>{
        new TwoPhaseCarbonationMaterialProperties{
