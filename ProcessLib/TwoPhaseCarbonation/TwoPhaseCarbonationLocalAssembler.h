...
{
    explicit IntegrationPointData(TwoPhaseCarbonationMaterialProperties&
            material_property_)
        : mat_property(material_property_),
        rho_mol_sio2(0.0)
    {
    }
    TwoPhaseCarbonationMaterialProperties&
        mat_property;
    double rho_mol_sio2;
    double rho_mol_sio2_pre;
...
class TwoPhaseCarbonationLocalAssemblerInterface
...
template <typename ShapeFunction, typename IntegrationMethod,
          unsigned GlobalDim>
class TwoPhaseCarbonationLocalAssembler
    : public TwoPhaseCarbonationLocalAssemblerInterface
{
...
public:
    TwoPhaseCarbonationLocalAssembler(
        MeshLib::Element const& element,
        std::size_t const /*local_matrix_size*/,
        bool const is_axially_symmetric,
        unsigned const integration_order,
        TwoPhaseCarbonationProcessData const& process_data)
        : _element(element),
...
private:
    ...
    TwoPhaseCarbonationProcessData const& _process_data;
...
#include "TwoPhaseCarbonationLocalAssembler-impl.h"
